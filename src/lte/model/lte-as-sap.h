...
public:
  ...
  /**
   * Notify that a bearer has actually been configured
   */
  virtual void NotifyBearerSetup() = 0;
};
...
public:
  ...
  virtual void NotifyBearerSetup ();
private:
  MemberLteAsSapUser ();
  C* m_owner;
};
...
template <class C>
void 
MemberLteAsSapUser<C>::NotifyBearerSetup ()
{
  m_owner->DoNotifyBearerSetup ();
}
