...
public: 
  ...
  virtual void ForwardIabS1apMessage(Ptr<Packet> packet, uint64_t imsi) = 0;
...
public:
  ...
  virtual void InitialContextSetupRequest (uint64_t mmeUeS1Id,
                                           uint16_t enbUeS1Id,
                                           std::list<ErabToBeSetupItem> erabToBeSetupList, bool iab) = 0;
  ...
  virtual void ForwardIabS1apReply (Ptr<Packet> p) = 0;
...
public:
  ...
  virtual void ForwardIabS1apMessage(Ptr<Packet> packet, uint64_t imsi);
...
template <class C>
void MemberEpcS1apSapEnbProvider<C>::ForwardIabS1apMessage (Ptr<Packet> packet, uint64_t imsi)
{
  m_owner->DoForwardIabS1apMessage (packet, imsi);
}
...
public:
  ...
  virtual void InitialContextSetupRequest (uint64_t mmeUeS1Id, uint16_t enbUeS1Id, std::list<ErabToBeSetupItem> erabToBeSetupList, bool iab);
  ...
  virtual void ForwardIabS1apReply (Ptr<Packet> p);
private:
  MemberEpcS1apSapEnb ();
  C* m_owner;
};
...
template <class C>
void MemberEpcS1apSapEnb<C>::InitialContextSetupRequest (uint64_t mmeUeS1Id, uint16_t enbUeS1Id, std::list<ErabToBeSetupItem> erabToBeSetupList, bool iab)
{
  m_owner->DoInitialContextSetupRequest (mmeUeS1Id, enbUeS1Id, erabToBeSetupList, iab);
}
...
template <class C>
void MemberEpcS1apSapEnb<C>::ForwardIabS1apReply (Ptr<Packet> p)
{
  m_owner->DoForwardIabS1apReply (p);
}
...
public:
  ...
  virtual void SendInitialContextSetupRequest (uint64_t mmeUeS1Id, uint16_t enbUeS1Id, std::list<ErabToBeSetupItem> erabToBeSetupList, uint16_t cellId, bool iab);
...
template <class C>
void MemberEpcS1apSapMmeProvider<C>::SendInitialContextSetupRequest (uint64_t mmeUeS1Id, uint16_t enbUeS1Id, std::list<ErabToBeSetupItem> erabToBeSetupList, uint16_t cellId, bool iab)
{
  m_owner->DoSendInitialContextSetupRequest (mmeUeS1Id, enbUeS1Id, erabToBeSetupList, cellId, iab);
}
